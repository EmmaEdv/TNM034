...
%                 else
            ...
            case 2
                if(img1_n(i,j) == 1)
                    ...
                    if(whiteCounter >= 0.75*blackCounter && whiteCounter <= 1.75*blackCounter)
                        centerCounter = 1;
                        status = 3;
                    else
                        status = 0;
            ...
            case 3
                if(img1_n(i,j) == 0)
                    ...
                    if(centerCounter >= 2.75*blackCounter && centerCounter <= 3.75*blackCounter)
                        whiteCounter = 1;
                        status = 4;
                    else
                        status = 0;
            ...
            case 5
                if(img1_n(i,j) == 0)
                    ...
                    if(blackCounter >= 0.75*whiteCounter && blackCounter <= 1.75*whiteCounter)
