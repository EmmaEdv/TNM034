...
function [ wholeText ] = readQR( img, bitSize )
...
figure
    ...
    %crop the image so that it only shows the qr code
    xmin = (centerPoints(1,1)-3.5*bitSize);
    ymin = (centerPoints(1,2)-3.5*bitSize);
    width = 41*bitSize;
    height = 41*bitSize;
